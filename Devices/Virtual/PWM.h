...
#define TIMER_TICK_TIME  276480L // OUR_FOC / 8 when T1CONbits.TCKPS = 1;

typedef  void (*PwmThread)(void);

typedef enum{CHANGE_PERIOD, CHANGE_DUTY_CYCLE}PWMTypes;

Service * NewPWM(volatile unsigned *, unsigned);
#endif
